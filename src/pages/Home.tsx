...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Random Bible Verse Generator - Free Bible Verse Generator Tool</title>
        <meta 
          name="description" 
          content="Free Random Bible Verse Generator - Generate random Bible verses from KJV, NIV, ESV & more translations. AI-powered Bible verse finder for daily inspiration, Bible study & spiritual growth."
        />
        <link rel="canonical" href="https://randomversegenerator.com/" />
      </Helmet>
            ...
            <article className="prose prose-neutral max-w-none">
              ...
              <div className="space-y-8">
                <p className="text-neutral-600 leading-relaxed">
                  Discover meaningful Bible verses with our random bible verse generator. 
